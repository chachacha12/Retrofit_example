...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
                ...
                .enqueue(object : Callback<GetAll> {
                    ...
                    override fun onResponse(call: Call<GetAll>, response: Response<GetAll>) {
                        if (response.isSuccessful) {
                            ...
                            val jsonArray =
                                JSONArray(response.body()?.result.toString())  //(response.body()?.result.toString()은 대괄호([])로 시작해서 여러 jsonobject있는 String임
        ...
        button_deleteCnt.setOnClickListener {
            server.deleteCntRequest("Bearer " + currentuser.access_token, "SPVBcoLmFtZ8OJfO9F0V")
                .enqueue(object : Callback<success> {
                    override fun onFailure(call: Call<success>, t: Throwable) {
                    }
        ...
        button_PatchLog.setOnClickListener {
            var log = Log("OA7KtWMhycQFuG9k6Bys", "2021-01-01 09:00", 2, 1, 2, 2, "수정완료")
            server.modifiy_log("Bearer " + currentuser.access_token, "ByHlxzivsMpNF2k5825N", log)
                .enqueue(object : Callback<success> {
                    override fun onFailure(call: Call<success>, t: Throwable) {
                    }
        ...
        button_getAllLog.setOnClickListener {
            server.getAllLogRequest("Bearer " + currentuser.access_token, "OA7KtWMhycQFuG9k6Bys")
                .enqueue(object : Callback<GetAll> {
                    override fun onFailure(
                        call: Call<GetAll>,
                        t: Throwable
        ...
        button_getLogList.setOnClickListener {
            server.getLogListRequest("Bearer " + currentuser.access_token, "OA7KtWMhycQFuG9k6Bys",0,1)
                .enqueue(object : Callback<GetAll> {
                    override fun onFailure(
                        call: Call<GetAll>,
                        t: Throwable
                    ...
                    override fun onResponse(call: Call<GetAll>, response: Response<GetAll>) {
                        if (response.isSuccessful) {
                            val jsonArray = JSONArray(response.body()?.result.toString())
                            Log.e("태그", "이용자 로그리스트 조회성공" + jsonArray)
